...
db.people.find({ $or: [ { first_name: "Michigan" }, { state: "Michigan" } ] }).sort({first_name: 1})
// 10. List all people who are named Virginia or live in Virgina.
db.people.find({ $or: [ { first_name: "Virgina" }, { state: "Virgina" } ] })
